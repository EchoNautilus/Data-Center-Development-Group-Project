...
default_args = {
    ...
    'start_date': pendulum.datetime(2024, 5, 28, 11, 26, 0, tz='Asia/Jakarta'),
...
urls = [
    # PUT YOUR URLS HERE
    {"title": "our-world-in-data-covid19", "url": "https://covid.ourworldindata.org/data/owid-covid-data.csv"},
]
